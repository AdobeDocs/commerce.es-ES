...
1. **Configurar una tienda Commerce en[!DNL Edge Delivery Services]**
   ...
   Siga la [documentación de configuración de tienda](https://experienceleague.adobe.com/developer/commerce/storefront/setup/){target="_blank"} para conectar su tienda a la instancia [!DNL Commerce Optimizer] y comenzar a ofrecer experiencias de comercio personalizadas.
