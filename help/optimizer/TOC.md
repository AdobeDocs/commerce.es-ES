...
- Administración de resultados {#manage-results}
  ...
  - {hide-from-toc}[Coincidencia y clasificación de búsqueda](./manage-results/search-relevance-matching.md)
...
- Configuración de tienda {#setup}
  - [Fuentes de catálogo](./setup/catalog-sources.md)
  - [Vistas de catálogo](./setup/catalog-view.md)
  - [Vistas del catálogo privado](./setup/private-catalog-view.md)
  - [Claves de acceso restringido](./setup/restricted-access-keys.md)
  ...
  - [Búsqueda semántica](./setup/semantic-search.md)
  - Eventos {#events}
