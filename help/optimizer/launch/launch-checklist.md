...
▢ Los metadatos de título de documento están presentes para las páginas clave (especialmente PDP y PLP). Consulte los [metadatos SEO](https://experienceleague.adobe.com/developer/commerce/storefront/setup/seo/metadata/?lang=es){target="_blank"} en la documentación de _Adobe Commerce Storefront_.
...
▢ La representación previa está activada para las páginas clave. Consulte [Procesamiento previo para AEM](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-prerender/?lang=es){target="_blank"} en la documentación de _Adobe Commerce Storefront_.
...
▢: la integración de imágenes del producto está aprovisionada. Consulte [Resumen de acceso a AEM Cloud Service](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/accessing/overview#).
