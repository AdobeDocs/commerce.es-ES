...
[!DNL Product Recommendations] requiere [datos de catálogo y comportamiento](development-overview.md) para funcionar. El proceso de sincronización de datos del catálogo permanece sin cambios en una implementación sin encabezado, pero se necesitan cambios para la recopilación de datos de comportamiento.
