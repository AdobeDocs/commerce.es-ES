...
![Nuevo](../assets/new.svg): Se agregó compatibilidad con una [tienda AEM](overview.md#supported-architecture).
...
![Corrección](../assets/fix.svg) Se ha corregido un problema por el que el botón **[!UICONTROL Refresh]** no sincronizaba correctamente los atributos personalizados de Experience Platform con el recopilador de back office.
