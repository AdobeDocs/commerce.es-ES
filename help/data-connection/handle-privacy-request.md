...
# Cómo administran los servicios de [!DNL Commerce] las solicitudes de privacidad
...
* A través de la **IU de Privacy Service**. Consulte la documentación [aquí](https://experienceleague.adobe.com/es/docs/experience-platform/privacy/ui/user-guide){target="_blank"}.
...
* [Administración de permisos para Privacy Service](https://experienceleague.adobe.com/es/docs/experience-platform/privacy/permissions)
