...
![Nuevo problema](../assets/new.svg)<!-- Issue ACAP-1246 -->: el administrador de Commerce incluye una lista [!UICONTROL Sync Status] centrada en los recursos para buscar, filtrar, ordenar y revisar los AEM Assets sincronizados por atributos de recursos en lugar de por asociaciones de productos. Ver [Ver estado de sincronización de AEM Assets](get-started/sync-status.md){target=_blank}.

## Versión 1.3.6

_14 de mayo de 2026_
...
![Se ha corregido un problema](../assets/fix.svg)<!-- Issue ACAP-1223 -->. Se ha corregido un problema por el que aparecían conjuntos duplicados de funciones de imagen de producto en el Administrador de productos configurables.

![Se ha corregido un problema](../assets/fix.svg)<!-- Issue CCSAAS-4769 --> que causaba una infracción de restricción de integridad en `UpdateAssetImageRolesDataPatch` durante las actualizaciones o los parches de datos.
