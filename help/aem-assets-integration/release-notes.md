...
![Se ha corregido un problema](../assets/fix.svg)<!-- Issue ACAP-1180 -->: mejoras generales en la página de edición del producto. Ahora, las páginas se preprocesan correctamente cuando la integración de AEM Assets está habilitada.
