...
1. Habilite y programe el trabajo cron `sync_order_payment_status` para que las actualizaciones de estado se recuperen automáticamente. Consulte [Configurar trabajos cron](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs).
