...
>[!NOTE]
>
>Los informes de pagos solo muestran los pedidos capturados (la acción de pago se ha establecido en [`Authorize and Capture`](production.md#set-payment-services-as-payment-method)) o [marcados como `Invoiced`](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/invoices#create-an-invoice).
