...
_2 de septiembre de 2026_

![Corrección](../assets/fix.svg) actualizaciones para admitir la integración de Adobe Commerce Optimizer con Adobe Commerce.<!--MDEE-1417-->

### Versión 103.4.33

_1 de septiembre de 2026_

![Corregir](../assets/fix.svg) **resincronizaciones más rápidas para los catálogos de vista de varias tiendas**- Las fuentes de productos y categorías ahora filtran por vista de tienda antes de extraer datos, en lugar de extraer cada vista de tienda y descartar los resultados irrelevantes posteriormente. Esta actualización mejora significativamente el rendimiento de resincronización de los catálogos con muchas vistas de tienda, especialmente cuando se utiliza Adobe Commerce Optimizer. <!--MDEE-1441-->
...
![Corregir](../assets/fix.svg) **URL de categoría precisas después de actualizaciones programadas**: se ha corregido un problema por el que los cambios programados en la URL de categoría podían dejar slugs duplicados o antiguos en los servicios conectados de Commerce. Los vínculos Navegación de categorías y Categoría de productos ahora muestran la URL actualizada después de aplicar el cambio.
...
![Corrección](../assets/fix.svg) **Se respetan los permisos de catálogo en varios grupos de tiendas**: en configuraciones de tiendas complejas, los productos permitidos siguen siendo detectables en Live Search y experiencias relacionadas para los grupos de clientes adecuados, en lugar de ocultarse cuando entren en conflicto las reglas de permisos.

<!--MDEE-1334-->

![Corregir](../assets/fix.svg) **Advertencia más clara antes de restablecer la fuente completa**-Usar `saas:resync` con la opción `--cleanup-feed` ahora explica que el estado de exportación local se restablece y que SaaS puede no estar sincronizado con su catálogo. Utilice esta opción solo para reconstrucciones de entorno completas, no para la solución de problemas rutinaria.
...
![Corrección](../assets/fix.svg) ha resuelto un problema en el que el comando `di:compile` fallaba en PHP 8.5. El proceso de compilación ahora se completa correctamente, lo que garantiza la compatibilidad con la última versión de PHP.<!--MDEE-1299-->
