...
![Corregir](../assets/fix.svg) Se corrigió un problema en el cual al actualizar los precios de nivel de un producto no se eliminaban los valores antiguos, lo que resultaba en entradas de precios de nivel duplicadas u obsoletas. Ahora, solo se muestran los precios de nivel actuales después de las actualizaciones. <!--MDEE-1157-->  
