...
>[!NOTE]
>
>Para obtener más información sobre las características disponibles en [!DNL Adobe Commerce as a Cloud Service] (SaaS) y cómo se alinean esas características con otras versiones de Adobe Commerce, como [!DNL Adobe Commerce on Cloud] y [!DNL Adobe Commerce on Premises] (PaaS), vea [Comparación de características](../cloud-service/feature-comparison.md).
