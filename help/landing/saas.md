...
Si no es el propietario de la licencia, debe obtener las claves de la API de Commerce de la persona o el equipo propietario de la licencia de Commerce para su tienda.

>[!NOTE]
>
>Las claves API solo las puede generar el propietario de la licencia. No hay ninguna capacidad de acceso compartido que permita a otros usuarios generarlos.
