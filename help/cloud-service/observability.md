...
[Supervisión de usuarios reales proxy (RUM)](https://experienceleague.adobe.com/en/tools/commerce-storefront/setup/configuration/content-delivery-network/#proxy-rum-through-the-origin-to-avoid-a-tls-handshake) recopilación de datos a través de su origen de CDN para eliminar un protocolo de enlace TLS adicional y mejorar la medición de rendimiento front-end.
