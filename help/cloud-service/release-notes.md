...
Los siguientes elementos se lanzarán a los entornos de producción el 1 de abril de 2026.

>[!BEGINSHADEBOX]

### Comprobación del estado de suscripción de alertas de precios y cotizaciones mediante GraphQL

Las nuevas consultas de GraphQL, `isSubscribedProductAlertStock` y `isSubscribedProductAlertPrice`, permiten a las tiendas determinar si un comprador ya está suscrito a las alertas de existencias o precios de un producto. <!-- ACCS-334 -->
...
La consulta `recaptchaFormConfigs` puede devolver la configuración de varios tipos de formulario en una única solicitud en lugar de requerir una consulta por formulario. <!-- ACCS-628 -->
