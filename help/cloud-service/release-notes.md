...
Los siguientes elementos se lanzarán a los entornos de producción el 16 de abril de 2026.
...
[Las reglas de recordatorio de correo electrónico](https://experienceleague.adobe.com/es/docs/commerce-admin/marketing/communications/email-reminders/email-reminder-rules) ahora admiten una configuración opcional de reutilización de reglas que permite que la misma regla se vuelva a aplicar a un cliente después de que ya no se aplique la condición de déclencheur original.
