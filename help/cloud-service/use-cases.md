---
title: Casos de uso
description: Aprenda a lograr casos de uso prácticos y escenarios empresariales admitidos con Adobe Commerce as a Cloud Service.
role: User, Leader
...
Los siguientes casos de uso muestran la funcionalidad principal y los escenarios empresariales admitidos por Adobe Commerce as a Cloud Service, lo que le permite acelerar el desarrollo e iniciar experiencias de alto impacto.
...
1. En el Administrador de Commerce, vaya a [!UICONTROL **Configuración**] > [!UICONTROL **Métodos de pago**].
...
1. Abra Creación de documentos. Navegando a `https://da.live/#/<GitHub User Name>/<Repository Name>/main/da/index.md`.
...
1. En la vista Creación de documentos de tu tienda, selecciona tu página de índice y haz clic en [!UICONTROL **Copiar**].
...
1. En el [panel de navegación](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/sites/authoring/basic-handling#navigation-panel) de AEM as a Cloud Service, seleccione **Assets** > **Archivos** > **Commerce** y haga clic en el recurso que creó en la sección anterior.
...
1. Abrir [Generar variaciones](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations)
