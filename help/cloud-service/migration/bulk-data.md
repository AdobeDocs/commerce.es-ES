...
>[!IMPORTANT]
>
>Los ajustes de configuración no se importan automáticamente. Antes de comenzar el proceso de migración de datos, tome nota de la configuración actual del catálogo en [!DNL Commerce Admin]. A continuación, implemente la misma configuración en el entorno de destino [!DNL Adobe Commerce as a Cloud Service].
