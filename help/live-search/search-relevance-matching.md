...
description: Aprenda cómo  [!DNL Live Search] prioriza las coincidencias exactas y cercanas, las coincidencias del mismo campo y las coincidencias entre campos, y cómo la clasificación interactúa con las ponderaciones de búsqueda, la clasificación inteligente y las reglas de comercialización.
...
Establezca **Idioma** en **Alemán** en el área de trabajo de [Configuración](settings.md#language), de modo que se apliquen las reglas de descomposición. Valide consultas alemanas de alto valor en una tienda de ensayo antes de habilitar los cambios en la producción.
...
- [Agregar reglas de búsqueda](rules-add.md)
