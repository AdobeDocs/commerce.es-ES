...
En esta sección, aprenderá a optimizar la funcionalidad de búsqueda mediante funciones como autocompletar, sinónimos y facetas.
...
Live Search administra los errores ortográficos de forma predeterminada. Para incluir palabras que los compradores utilizan y que difieren de las palabras especificadas en el catálogo, configure sinónimos. Usted no quiere perder una venta porque alguien está buscando un &quot;sofá&quot;, mientras que su producto aparece como un &quot;sofá&quot;. Usted captura una amplia gama de términos de búsqueda al introducir todas las palabras posibles que los clientes utilizan para encontrar sus productos. Para mejorar los resultados, [establezca los sinónimos de una o dos maneras](synonyms-add.md#step-2-define-the-synonym-by-type).
...
- Incluya jerga y términos específicos del sector que los compradores utilizan de forma intercambiable, como &quot;zapatillas de deporte&quot; y &quot;zapatillas de running&quot;.
...
- Pruebe la eficacia de las asignaciones de sinónimos analizando los resultados de búsqueda y los comentarios del comprador. Para mejorar la precisión y la relevancia, perfeccione las asignaciones.
...
- Determine los atributos más relevantes para sus productos y configúrelos como [facetas dinámicas](facets-type.md). 
...
- Para mantener la interfaz limpia y manejable, especialmente en dispositivos móviles, implemente secciones de faceta contraíbles.
...
Asegúrese de que los productos secundarios de los productos configurables tengan imágenes con las funciones correctas. Si faltan productos principales o secundarios, el resultado de la búsqueda no tendrá imágenes.

>[!NOTE]
>
>Las imágenes de los resultados de búsqueda difieren según el término de búsqueda. Si el término de búsqueda determina que un producto secundario es más relevante, las imágenes del producto secundario reemplazan a las imágenes del producto principal.
...
Para optimizar los resultados de búsqueda con [!DNL Live Search], supervise los KPI para comprender cómo los compradores interactúan con la funcionalidad de búsqueda. Estos datos le guían para actualizar y perfeccionar regularmente las reglas de búsqueda.
...
- **Búsquedas únicas**: El recuento de consultas de búsqueda distintas realizadas en el sitio [!DNL Commerce]. El sistema contabiliza cada búsqueda única solo una vez, incluso si el mismo comprador o diferentes lo repiten varias veces. Esta métrica le ayuda a comprender la diversidad de términos de búsqueda utilizados por los clientes y proporciona información sobre los productos o la información que buscan los compradores. El seguimiento de búsquedas únicas le permite:
...
- **Posición de clic promedio**: indica la posición promedio de los resultados de búsqueda en los que hicieron clic los compradores después de realizar una consulta de búsqueda en el sitio. Esta métrica proporciona perspectivas sobre la relevancia y la eficacia de los resultados de búsqueda.
...
- **Resultados populares**: mejora los resultados de búsqueda alineándolos con las preferencias y los comportamientos de los compradores.

Puede utilizar estos datos de métricas para optimizar la funcionalidad de búsqueda de las siguientes maneras:

- Para clasificar los productos más populares en los resultados de búsqueda, implemente reglas. Los productos en los que se hace clic con frecuencia o que se compran pueden tener prioridad para aparecer en la parte superior. Seleccione manualmente listas de productos populares para consultas de búsqueda específicas y asegúrese de que estos artículos se muestran de forma destacada.
- Resaltar productos que actualmente son tendencias o que recientemente han visto un pico en popularidad. Esta estrategia es efectiva durante eventos de temporada, festivos o períodos promocionales. Para conseguirlo, utilice la clasificación inteligente que mejor se adapte a su caso de uso y a sus necesidades comerciales al configurar una regla de búsqueda.
...
- Para identificar palabras clave importantes, analice los términos de búsqueda populares y los datos del producto. Para mejorar la relevancia de la búsqueda, optimice los atributos en los que se puede buscar productos con estas palabras clave.
- Analice con regularidad los datos de resultados para comprender los cambios en las tendencias, las preferencias y el comportamiento de los compradores, identificar los términos de búsqueda principales y detectar problemas. Utilice este bucle de comentarios para perfeccionar y mejorar continuamente las reglas de búsqueda y las ofertas de productos.
