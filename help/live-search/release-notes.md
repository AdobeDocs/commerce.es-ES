...
![Corrección](../assets/fix.svg) En la tienda, se ha quitado el vínculo de pie de página de [Términos de búsqueda](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/catalog/search/search-terms) y se ha deshabilitado su caché para [!DNL Live Search] instalaciones.
