...
[!BADGE Compatible]{type=Informative tooltip="Admitido"} versiones de Adobe Commerce 2.4.5 y posteriores

![Corrección](../assets/fix.svg) Se ha corregido un problema por el que la funcionalidad Agregar al carro de compras de la página Lista de productos no funcionaba con el widget PLP en algunos casos aislados.
...
![Corrección](../assets/fix.svg) Se ha corregido un error que se producía en ciertas condiciones relacionadas con la funcionalidad de la extensión de Visual Merchandiser.
...
![Corrección](../assets/fix.svg) Se ha corregido la consulta de GraphQL [`productSearch`](https://developer.adobe.com/commerce/webapi/graphql/schema/live-search/queries/product-search#filtering-by-categories) para filtrar correctamente en función de `categoryPath` y `categoryList` para las categorías.
...
![Corrección](../assets/fix.svg) Se ha corregido un problema que hacía que la ventana emergente de búsqueda mostrara el símbolo de moneda siempre delante del valor de precio, independientemente de la configuración regional.
...
![Corrección](../assets/fix.svg): Se cambió el nombre de &#39;Tipo de clasificación&#39; a &#39;Clasificación inteligente&#39;.
![Corregir](../assets/fix.svg) correcciones de errores menores.
...
![Nueva](../assets/new.svg) tarjeta de elemento de producto en la vista previa de reglas.
...
![Corregir](../assets/fix.svg) En la tienda, se quita el vínculo de pie de página de [Términos de búsqueda](https://experienceleague.adobe.com/es/docs/commerce-admin/catalog/catalog/search/search-terms) y se deshabilita su caché para [!DNL Live Search] instalaciones.
